...
const PRODUCT_CATEGORIES = [
  {
    ...
    description:
      "High-purity reagents, acids, bases, solvents, and indicators — sourced from certified global manufacturers.",
    icon: (
  ...
  {
    id: 2,
    title: "Glassware & Apparatus",
    description:
      "Borosilicate beakers, flasks, test tubes, condensers, burettes, and precision measuring instruments.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Lab Equipment",
    description:
      "Microscopes, centrifuges, hot plates, pH meters, analytical balances, and more — built for precision.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Lab coats, goggles, gloves, fume hoods, fire extinguishers, and first-aid kits — safety always comes first.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Models & Charts",
    description:
      "Anatomical models, molecular kits, educational charts, and 3D models for engaging classroom learning.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "End-to-end laboratory setup solutions for schools — design, procurement, installation, and training.",
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-gray-600 text-base md:text-lg font-body leading-relaxed">
            Comprehensive laboratory solutions trusted by educational
